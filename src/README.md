...
| <a name="module_roles_to_principals"></a> [roles\_to\_principals](#module\_roles\_to\_principals) | github.com/cloudposse-terraform-components/aws-account-map//src/modules/roles-to-principals | v1.537.1 |
...
| <a name="input_ecs_cluster_component"></a> [ecs\_cluster\_component](#input\_ecs\_cluster\_component) | Component name used to lookup the ECS cluster remote state | `string` | `"ecs"` | no |
...
[<img src="https://cloudposse.com/logo-300x69.svg" height="32" align="right"/>](https://cpco.io/homepage?utm_source=github&utm_medium=readme&utm_campaign=cloudposse-terraform-components/aws-datadog-private-location-ecs&utm_content=)
